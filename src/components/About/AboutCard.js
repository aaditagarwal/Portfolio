        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              I have been exploring and working in the technology space, specifically <span className="purple">Software Engineering</span> and <span className="purple">Back-end Engineering</span>, 
              ...
              I like to learn and feed my curiousity on numerous skills of the technical world and think along the lines of clean, maintable and scalable code, mostly in
              ...
              My extrovert attitude helps me amplify <span className="purple">communication</span> and <span className="purple">socializing</span> skills.
              <br />
              <br />
